...
→ 280 S0618 The speaker says that sometimes they can be aggressive and will tell someone to "fuck off" if necessary, and describes how with an ex-friend they initially blanked her after a big falling out, then used the distance to reflect and decide the friendship was unhealthy and that they no longer wanted any involvement with that person.
