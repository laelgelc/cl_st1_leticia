...
→ 427 S0262 The speaker explains that real, co-created moving image case studies are valuable because they are authentic rather than invented, can be sold to higher education institutions that struggle to keep up with new themes and lack skills in producing such materials, and can be used in tutorials or online units with integrated teaching and learning resources to better engage learners—especially online students—by providing a real-life example (such as collaboration) that both instructors and learners can effectively use.
...
435 S0262 because their online content won't move as fast as this the narrative in the storytelling of the case study will never match anything that they're capable of doing themselves and I can tell you that for sure unless the one with the has got that entertainment content concept going the learning o the learning that comes from an entertaining and entertainment's hard cos it's so subjective so that's why a real lives case study is almost as good as watching a film but it's better because it's real and it's not a documentary cos the documentary comes from a different documentary filmmaking comes from a different perspective it will have most times it's got preconceived ideas of what the story's gonna be so like when you watch Louis Theroux for example the narrative has already been written before they've even gone to America to interview the people so that's not really fair we're projecting it as real life but it's been written by

436 S0261 and it's not essentially scripted
