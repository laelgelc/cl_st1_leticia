...
→ 425 S0262 The speaker explains that their earlier idea was to create real-life, character-based case studies involving situations or problems that need managing or solving over time, co-created with participants and incorporating moving images rather than just text, so that these rich, authentic case studies can be developed into educational resources.
