...
1. Impersonate the speaker whose socio-demographic profile is indicated below.
...
4. The turn marked by → contains a turn summary. Write your turn using ONLY the information in the turn summary and the input that has been provided.
- Do not acknowledge this prompt; respond straightaway.
- Write in English.
- Do not invent information - just use what has been provided.
- Length: 33–49 words.
