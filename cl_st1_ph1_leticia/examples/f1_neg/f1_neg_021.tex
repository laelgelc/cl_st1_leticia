\begin{textsample}{NEG Dim 1 – unprofiled\_gpt – Score -7.00 – unprofiled\_gpt/t001619\_gpt.txt}  \label{ex:f1_neg_021}
...
They also talk about the money and energy some Muslims have put into opposing same‑sex marriage – campaigning, lobbying, \textbf{trying} to get laws changed to restrict other people ’s lives.
...
And the most natural allies are other marginalised groups – including LGBT communities – who also know what it feels like to be vilified and excluded.
So if Muslims stand with LGBT people now, even when it ’s uncomfortable, those communities are more likely to stand with Muslims when Islamophobia flares up, or when there ’s another attempt to ban hijabs or spy on mosques.
...
The letter is more about behaviour in the public sphere than private belief.
...
They also address this idea that supporting civil marriage equality is the \textbf{same} as “ glorifying ” homosexuality.
...
And they finish on that point : that defending the civil rights of LGBT people – not because you suddenly think \textbf{everything} they do is religiously fine, but because you believe no one should be treated as a second‑class citizen – is both the right thing to do *and* the Muslim thing to do.
...
% matched lemmas: clear, everything, expect, push, real, same, try
\end{textsample}
