\begin{textsample}{NEG Dim 3 – profiled\_gpt – Score -2.00 – profiled\_gpt/t000320\_gpt.txt}  \label{ex:f3_neg_005}
...
Over time, though, we ’ve drifted away from following it page by page, and now I mostly use it as a source of topic ideas or the \textbf{odd} exercise if it fits.
The lesson itself is really led by whatever she wants to talk about on the day.
The only real “ system ” I stick to is my A4 sheet.
...
Another section is for new vocabulary, often idioms, and I ’ll jot down the phrase and a quick meaning so she ’s got a clear record.
...
If they ’re comfortable with phonetic symbols I ’ll use them, but quite often I just write things in a way that I know they ’ll remember and understand.
The idea is that the sheet makes \textbf{sense} to them, not that it ’s technically perfect.
She takes that A4 sheet away with her at the end of the lesson, so it becomes a little personalised record of what we did.
During the lesson I ’m doing on‑the‑spot correction when it feels appropriate, and if it doesn't, I just note it down for later and carry on.
