...
4. The socio-demographic profiles of the original speakers can be obtained from the metadata of each conversation.
...
6. There will be two types of turns generated by GPT:
   ...
   - A prompt that provides the socio-demographic profile of the original speaker to be simulated
   - A prompt that does not provide such a profile

7. The study corpus will contain about 4,900 turns. One third will consist of turns from the original human speakers. Another third will consist of synthetic turns guided by socio-demographic profile. The final third will consist of synthetic turns not guided by those profiles.
